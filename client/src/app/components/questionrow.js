...
class QuestionRow extends React.Component {
    ...
    async x() {
        if (this.props.title === 'Q') {
            this.props.admin(this.props.question, 'Q')            
            return (
                this.props.params(`/${this.props.location}/homePage:userPage:editPageQ:${this.props.question._id}`)    
            )
        }
        ...
        return (
            <tr className='question_details'>
                <td className='statisticsStyle'>
                    ...
                    <div>{this.props.question.votes} Votes</div>
                </td>
...
export default withParams(QuestionRow)